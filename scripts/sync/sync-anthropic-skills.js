...
async function syncSkills() {
  ...
  if (!dryRun) {
    try {
      ...
      // intentional: the script still recomputes metadata here, but callers/CI should treat such runs
      // as failures and avoid committing the updated metadata, even if the metadata file
      // itself was updated.
