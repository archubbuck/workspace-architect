---
agent: 'agent'
description: 'Suggest relevant GitHub Copilot Custom Agents files from the awesome-copilot repository based on current repository context and chat history, avoiding duplicates with existing custom chat modes in this repository.'
...
2. **Scan Local Custom Agents**: Discover existing custom chat mode files in `.github/agents/` folder
